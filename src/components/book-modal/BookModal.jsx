    ...
    return (
        <div className="fixed z-30 backdrop-blur top-0 left-0 min-h-full w-full shadow-lg">
            <div className="bg-slate-100 w-1/4 rounded-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pb-8">
                ...
                <form className="p-4 flex-col gap-4">
                    <DateRangePicker
                ...
                <div className="w-full flex items-center mt-6">
                    ...
                    onClick={handlePayment}
                     disabled= {isLoading}
                    className="w-3/4 mx-auto cursor-pointer rounded-lg py-3 px-6 text-xl text-white bg-blue-500 transition-all hover:bg-blue-500"
                    label="Submit"
                />
                </div>
            </div>
