...
const ModalLayout = ({
  ...
  console.log('modal layoyt', handleHideModel);
  return (
    <div className="z-9999 fixed backdrop-blur top-0 left-0 min-h-full w-full shadow-2xl">
        <div className="bg-white shadow-sm w-1/4 rounded-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pb-8">
